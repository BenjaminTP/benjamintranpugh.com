...
cover: double-pendulum/flip-fractal.png
...
<Figure src="double-pendulum/flip-fractal.png" caption="TIME-TO-FLIP ACROSS INITIAL CONDITIONS — FRACTAL STRUCTURE" />
...
<Figure src="double-pendulum/variations.png" caption="200 RUNS, Δθ₀ = 1e-9 RAD — DIVERGENCE OVER TIME" />

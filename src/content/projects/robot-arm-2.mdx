...
A working arm with full inverse kinematics, smooth controlled motion, and positional memory, controllable from any device on the network. The demo video below shows it running.
